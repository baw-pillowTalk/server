...
@Getter
public class ImageChattingMessage extends ChattingMessage{
    private String resourceUrl;

    @Builder
    public ImageChattingMessage(Member self, boolean isRead, ChattingRoom chattingRoom, Long number, String resourceUrl) {
